...
class LM_Model(Model):
    ...
    def load_dict(self, opts):
        ...
        self.coverage_dim = opts.get('coverage_dim', None)
        # added by Zhaopeng Tu, 2015-12-17
        self.use_fertility_model = opts.get('use_fertility_model', False)
        # added by Zhaopeng Tu, 2016-01-20
        self.use_linguistic_coverage = opts.get('use_linguistic_coverage', False)
